...
namespace CIIN\Controller
{
	...
	class FormTestController implements ControllerProviderInterface
	{
		public function connect( Application $app )
		{
			$formController = $app['controllers_factory'];
			$formController->get("/form", array( $this, 'index' ) )->bind( 'form' );
